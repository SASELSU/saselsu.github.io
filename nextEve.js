...
fetch(FULL_URL)
    .then(res => res.text())
        ...
        document.getElementById('EventStart').appendChild(document.createTextNode(data.table.rows[0].c[2].f));
        document.getElementById('EventEnd').appendChild(document.createTextNode(" - " + data.table.rows[0].c[3].f));
