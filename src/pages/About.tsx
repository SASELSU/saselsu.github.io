...
import { HistoryCard } from "./helpers/aboutHelpers";
            ...
            <div className="aboutHistory">
                ...
                <div className="historyCardSlider">
                    ...
                    > {/* ref={scrollRef} */}
                        ...
                        <HistoryCard
                            image={LunarMeeting}
                            cardBlurb="Through persistent dedication throughout the semester, our membership skyrocketed from the initial 25 to a remarkable 133 active participants by the spring of 2022. We remained steadfast in our commitment to enhancing visibility and nurturing a sense of community. Our Lunar New Year meeting exemplified the celebration of intercultural exchange, acting as a testament to our growth. "
                        />

                        <HistoryCard
                            image={ReallyBigGathering}
                            cardBlurb="As we expanded, we incorporated workshops and invited guest speakers to enable our members to pursue professional development. SASE LSU serves as a space where individuals can embrace intercultural exchange against all odds, forge their own community within LSU, and, above all, to love purple and live gold."
                        />
                    </div>
                </div>
