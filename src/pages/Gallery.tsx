...
const Gallery = () => {
    ...
    const handleSubmit = async e => {
        ...
        const timeMin = `${year}${semesterStart}`;
        const timeMax = `${year}${semesterEnd}`;
        ...
        const galleryList = data.items.map(gallery => {
            ...
            <div className="gallery">
                <div style={{ width: "30%", margin: "auto", marginTop: "2.5%", marginBottom: "2.5%", justifyContent: "center", alignItems: "center", padding: "1%", background: "white", borderRadius: "20px" }}>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <select id="year-select" value={year} style={{ marginRight: "2%", border: "none", borderRadius: "5px", color: "white", background: "rgb(0, 78, 100)", fontFamily: "Bebas Neue", padding: "5px", paddingLeft: "10px", paddingRight: "10px" }} onChange={e => setYear(e.target.value)}>
                            {yearList.map(year => (
